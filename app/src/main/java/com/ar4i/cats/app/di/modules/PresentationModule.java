...
public class PresentationModule {
    ...
    @Provides
    SplashPresenter provideSplashPresenter(ImagesInteractor imagesInteractor, SystemInteractor systemInteractor) {
        return new SplashPresenter(imagesInteractor, systemInteractor);
    }
